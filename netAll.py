...
class netAll(nn.Module):
    ...
    def forward(self,UUMat,DUMat,INMat,TAMat,CIMat):
        UUMat1, DUMat1, INMat1, TAMat1,CIMat1= self.Init(UUMat,DUMat,INMat,TAMat,CIMat)
        UUMat2, DUMat2, INMat2, TAMat2= self.Update(UUMat1,DUMat1,INMat1,TAMat1,CIMat1)
        UUMat1, DUMat1, INMat1, TAMat1= self.Update2(UUMat2,DUMat2,INMat2,TAMat2,CIMat1)
        UUMat2, DUMat2, INMat2, TAMat2= self.Update3(UUMat1,DUMat1,INMat1,TAMat1,CIMat1)
        UUPower, DUComMat, SensingMat= self.Output(UUMat2,DUMat2,INMat2,TAMat2)
